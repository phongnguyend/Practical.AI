...
/// belongs to. The persistence layer keeps it in SQL Server.
/// </summary>
...
/// record every pass would download, extract, embed, and re-upload files that never changed. The
/// persistence layer keeps it in SQL Server.
/// </summary>
